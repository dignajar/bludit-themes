...
<html class="js" lang="<?php echo $Site->language() ?>">
	...
	?>
		...
		<!-- Footer -->
		<!-- Remove this include if you want a cleaner footer -->
		...
		<div class="credits section">
			<div class="credits-inner section-inner">
				...
				<p class="credits-right">
					<span><a href="http://www.andersnoren.se">Lingonberry</a></span> <span>on</span> <span><a href="https://bludit.com/">Bludit</a></span>
				</p>
